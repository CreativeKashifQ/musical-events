...
class PayableFSupplierServiceDetail extends Component
{
    ...
    */
    public $offer, $payable_amount = 10;
    /*
    |--------------------------------------------------------------------------
    | Override Properties
    |--------------------------------------------------------------------------
    ...
    */
    ...
    {
        return view('livewire.payment.manage.components.payable-f-supplier-service-detail');
    }
