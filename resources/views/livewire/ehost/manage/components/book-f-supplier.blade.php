                        ...
                        <div class="col-md-3 col-3">
                            <div class="text-center pt-2  ">
                                <figure class="avatar avatar-lg" style="width:50px;height:50px;">
                                    <img src="{{  asset($fSupplier['fSupplier']->avatar) }}" alt="" />
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="mt-1">
                            ...
                            <div class="col-md-3 col-4">
                                <figure class="avatar avatar-lg mr-2" style="width:80px;height:80px;">
                                    <a target="blank" href="{{asset($menu->image)}}">
                                        <img src="{{ $menu->image != null ? asset($menu->image) : asset('images/default.png') }}" alt="">
                                    </a>
                                </figure><br>
                        ...
                        <div class="mt-1">
                            <div class="d-flex justify-content-end">
                                @if($fSupplier['available'])
                                <a href="{{route('send-offer.manage.offer-form',['serviceType' => 'f-supplier','serviceId'=> $fSupplier['fSupplier']->id])}}" class="btn btn-sm btn-secondary">Send Booking Request</a>
                                @endif
                            </div>
                        </div>
                    </div>
