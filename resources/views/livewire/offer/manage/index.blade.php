<x-cms-root>
    <div class="wrapper">
        <div class="row">
            <div class="col-lg-6 ">
                <h2 class="text-primary">{{ucfirst($service_type)}} Offers</h2>
                <div class="pb-3">
                    <h5>Active {{ucfirst($service_type)}} Offers</h5>
                    <p>Track your active or Iactive {{ucfirst($service_type)}} Offers, Use Details link to Accept or Decline Offer</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
