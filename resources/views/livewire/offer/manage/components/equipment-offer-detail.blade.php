...
<div class="row">
            <div class="col-lg-8 ">
                <h2 class="text-primary"> Equipment Offers Detail</h2>
                <div>
                    <h5>Active Equipment Offers Detail</h5>
                    <p>Track your Active Equipment Offers Detail</p>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between">
                    <div class="d-flex justify-content-start">
                        <ul class="nav nav-material ">
                            <li class="nav-item">
                                <a class="nav-link active text-success " href="{{route('offer.manage.index',['service' => 'equipment'])}}">Go
                                    Back</a>
                            </li>
