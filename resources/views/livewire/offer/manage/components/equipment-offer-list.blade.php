<div>
    <div class="row">
        <div class="col-lg-6 ">
            <h2 class="text-primary">Equipment Offers</h2>
            <div class="pb-3">
                <h5>Active Equipment Offers</h5>
                <p>Track your active or Iactive Equipments Offers, Use Details link to Accept or Decline Offer</p>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="row">
                ...
                <table class="table table-borderless card-body p-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="d-none d-lg-block">{{$equipment->location}} </span></td>
                            <td>{{$equipment->quantity}}</td>
                           
                            <td><span class="d-none d-lg-block">$ {{$equipment->hourly_rate}}</span>
                            </td>

                            <td><a href="{{ route('offer.manage.offer-card',['serviceType' => 'equipment','serviceId' => $equipment->id])}}">Details</a>
                            </td>
                        </tr>
                        @empty
    ...
    <br>
    <livewire:dev.comment align="left" component="Equipment Offer List" />
