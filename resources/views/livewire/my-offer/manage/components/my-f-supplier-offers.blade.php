<div>
    ...
    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="lslide active" style="width: 407.333px; margin-right: 10px;">
                    <div class="mb-2 card no-b p-3">
                        <h3 class="text-primary pb-0 mb-0">{{ $offer->service->user->name }} </h3>
                        <small class="text-muted">{{ $offer->service->user->email }} (Food
                            Supplier)</small><br>
                        ...
                        <div class="d-flex justify-content-end" >
                            <a href="{{route('send-offer.manage.offer-form',['serviceType' => 'f-supplier','serviceId' => $offer->service->id])}}"
                        ...
                        <div class="d-flex justify-content-end" >
                           @if($offer->booking == null || $offer->booking->status == 'pending' )
                            <a href="{{route('payment.manage.payable-service-card',['service' => 'f-supplier','offer' => $offer->id])}}"
        ...
        <livewire:dev.comment align="left" component="My Food supplier Offers" />
    </div>
</div>
