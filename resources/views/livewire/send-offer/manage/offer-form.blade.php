<x-cms-root>
    <a href="{{route('my-offer.manage.sent-offer')}}" class="font-weight-bold text-muted"> <i class="icon-arrow-left pr-2 "></i>Back</a>
    <div class="row">
        <div class="col-lg-4 offset-lg-4">
            <h2 class="text-primary text-center mb-4">Update {{ucfirst($serviceType)}} Offer Plan</h4>
                <div class="pb-3">
